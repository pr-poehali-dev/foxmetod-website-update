        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-slate-900 mb-4">Система ОКМ</h1>
                <p className="text-xl text-slate-600">
                  Внедрение системы Организации Качественной Мотивации для эффективного управления персоналом и достижения бизнес-целей
                </p>
              </div>
                ...
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">За полное внедрение системы ОКМ</p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-slate-600">С поэтапным внедрением и адаптацией</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <Card className="border-red-200 bg-red-50">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-slate-700">
                      ...
                      <li>• Отсутствие четких целей у сотрудников</li>
                      <li>• Субъективная оценка результатов</li>
                      <li>• Высокая текучесть персонала</li>
                      <li>• Неэффективная система поощрений</li>
                    </ul>
                  </CardContent>
                </Card>
              ...
              <Card className="mb-8">
                <CardHeader>
                  <CardTitle className="text-2xl text-slate-900">Как внедряется система ОКМ</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-2">Анализ текущей системы</h4>
                        <p className="text-slate-600">Оценка существующих подходов к мотивации, анализ проблем, изучение специфики бизнеса и команды</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">Создание показателей эффективности для каждой позиции, настройка системы оценки и контроля результатов</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">Обучение команды, пилотное внедрение, корректировка системы по результатам, полный запуск</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-blue-50 border-blue-200">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Анализ текущей системы мотивации</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Разработка KPI для всех позиций</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Настройка системы оценки</li>
                    </ul>
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Обучение руководителей</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Автоматизацию процессов</li>
              ...
              <div className="sticky top-8">
                <Card className="border-blue-200 bg-blue-50 mb-6">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Внедрим систему ОКМ для эффективного управления персоналом
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <p className="text-sm text-slate-600 text-center">
                      Консультация по системе ОКМ — бесплатно
                    </p>
                  </CardContent>
                </Card>
