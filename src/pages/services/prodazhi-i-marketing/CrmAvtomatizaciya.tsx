...
const CrmAvtomatizaciya: React.FC = () => {
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-slate-900 mb-4">CRM и автоматизация</h1>
                <p className="text-xl text-slate-600">
                  Внедрение и настройка CRM-систем с автоматизацией бизнес-процессов для эффективного управления продажами и клиентами
                </p>
              </div>
                ...
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">За внедрение и настройку CRM</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-2">Срок реализации</h4>
                      <p className="text-2xl font-bold text-slate-900">3-6 недель</p>
                      <p className="text-sm text-slate-600">В зависимости от сложности интеграций</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <Card className="border-red-200 bg-red-50">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-slate-700">
                      <li>• Потеря клиентских данных и контактов</li>
                      <li>• Отсутствие истории взаимодействий</li>
                      <li>• Дублирование работы менеджеров</li>
                      <li>• Невозможность прогнозирования продаж</li>
                      <li>• Ручные процессы и потеря времени</li>
                    </ul>
                  </CardContent>
                </Card>
              ...
              <Card className="mb-8">
                <CardHeader>
                  <CardTitle className="text-2xl text-slate-900">Как внедряется CRM</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-2">Анализ и выбор системы</h4>
                        <p className="text-slate-600">Анализ потребностей, выбор подходящей CRM-системы, планирование внедрения</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">Конфигурация системы, интеграция с существующими сервисами, настройка автоматизации</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">Обучение команды работе с CRM, тестирование процессов, полный запуск системы</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-blue-50 border-blue-200">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Выбор и закупка CRM-системы</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Настройка под ваши процессы</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Интеграция с другими системами</li>
                    </ul>
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Миграция существующих данных</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Обучение команды</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />3 месяца технической поддержки</li>
                    </ul>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="sticky top-8">
                <Card className="border-blue-200 bg-blue-50 mb-6">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Внедрим CRM-систему для автоматизации ваших продаж
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
...
export default CrmAvtomatizaciya;