...
const SistemnyjOtdelProdazh: React.FC = () => {
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 py-8">
          <nav className="mb-8">
            <div className="flex items-center space-x-2 text-sm text-slate-600">
              ...
              <Icon name="ChevronRight" size={16} />
              <span>Системный отдел продаж</span>
            </div>
          </nav>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-slate-900 mb-4">Системный отдел продаж</h1>
                <p className="text-xl text-slate-600">
                  Построение эффективной системы продаж от воронки и CRM до мотивации менеджеров и аналитики с предсказуемыми результатами
                </p>
              </div>
                ...
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">За построение системы продаж</p>
                    </div>
                    <div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <Card className="border-red-200 bg-red-50">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-slate-700">
                      <li>• Нестабильная выручка и прогнозы</li>
                      <li>• Зависимость от отдельных менеджеров</li>
                      <li>• Высокая стоимость привлечения клиентов</li>
                      <li>• Низкая конверсия лидов в продажи</li>
                      <li>• Отсутствие контроля над процессом</li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card className="border-green-200 bg-green-50">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-slate-700">
                      <li>• Рост выручки на 40-80%</li>
                      <li>• Предсказуемые продажи и планы</li>
                      <li>• Снижение CAC на 30-50%</li>
                      <li>• Рост конверсии в 2-3 раза</li>
                      <li>• Масштабируемая команда продаж</li>
                    </ul>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="mb-8">
                <CardHeader>
                  <CardTitle className="text-2xl text-slate-900">Как строится отдел продаж</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-2">Аудит и стратегия</h4>
                        <p className="text-slate-600">Анализ текущих продаж, определение целевой аудитории, разработка стратегии продаж и воронки</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-2">Процессы и инструменты</h4>
                        <p className="text-slate-600">Создание скриптов продаж, внедрение CRM, настройка аналитики и отчетности</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-2">Команда и мотивация</h4>
                        <p className="text-slate-600">Подбор и обучение менеджеров, создание системы мотивации, запуск и оптимизация</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-blue-50 border-blue-200">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Аудит текущих продаж</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Воронка продаж и скрипты</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Настройка CRM-системы</li>
                    </ul>
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Система мотивации продажников</li>
              ...
              <div className="sticky top-8">
                <Card className="border-blue-200 bg-blue-50 mb-6">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Построим эффективную систему продаж для роста выручки
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <p className="text-sm text-slate-600 text-center">
                      Консультация по продажам — бесплатно
                    </p>
                  </CardContent>
                </Card>
...
export default SistemnyjOtdelProdazh;