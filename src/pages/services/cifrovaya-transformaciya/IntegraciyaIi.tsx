        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-slate-900 mb-4">Интеграция ИИ</h1>
                <p className="text-xl text-slate-600">
                  Внедрение решений на основе искусственного интеллекта в бизнес-процессы для автоматизации и повышения эффективности работы компании
                </p>
              </div>
                ...
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">За интеграцию ИИ-решений</p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-slate-600">В зависимости от сложности задач</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <Card className="border-red-200 bg-red-50">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-slate-700">
                      <li>• Высокие затраты на рутинные операции</li>
                      <li>• Медленная обработка больших данных</li>
                      <li>• Человеческие ошибки в процессах</li>
                      <li>• Ограниченные возможности анализа</li>
                      <li>• Конкурентное отставание</li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card className="border-green-200 bg-green-50">
                  <CardHeader>
                    <CardTitle className="text-xl text-slate-900 flex items-center">
                      ...
                      Результаты интеграции ИИ
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2 text-slate-700">
                      <li>• Автоматизация до 80% рутины</li>
                      <li>• Мгновенная обработка данных</li>
                      <li>• Исключение человеческих ошибок</li>
                      <li>• Глубокая аналитика и прогнозы</li>
              ...
              <Card className="mb-8">
                <CardHeader>
                  <CardTitle className="text-2xl text-slate-900">Как интегрируется ИИ</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">Анализ процессов, выявление возможностей для ИИ, выбор подходящих технологий</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-2">Разработка и обучение</h4>
                        <p className="text-slate-600">Создание ИИ-моделей, обучение на ваших данных, тестирование решений</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">Интеграция в рабочие процессы, обучение команды, мониторинг и улучшение</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-blue-50 border-blue-200">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Аудит возможностей для ИИ</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Разработка ИИ-решений</li>
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Обучение моделей на данных</li>
                    </ul>
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-center"><Icon name="Check" className="text-green-500 mr-2" size={16} />Интеграция в процессы</li>
              ...
              <div className="sticky top-8">
                <Card className="border-blue-200 bg-blue-50 mb-6">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Внедрим ИИ-решения для автоматизации ваших бизнес-процессов
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
